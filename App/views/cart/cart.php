...
<div class="container my-5">
    ...
    <?php if (!empty($cart)): ?>
        <div class="d-flex flex-wrap justify-content-start">
            <?php foreach ($cart as $id => $item): ?>
                <div class="card shadow-sm mx-2 mb-4" style="width: 18rem;">
                    <div class="row g-0">
                        <div class="col-4">
                            <?php if ($item['image']): ?>
        ...
        <div class="d-flex justify-content-between mt-4">
            <a href="/s4_php/shop/index" class="btn btn-secondary">Tiếp tục mua sắm</a>
    ...
    <?php else: ?>
        ...
        <div class="text-center">
            <a href="/s4_php/shop/index" class="btn btn-primary">Tiếp tục mua sắm</a>
        </div>
    <?php endif; ?>
</div>
